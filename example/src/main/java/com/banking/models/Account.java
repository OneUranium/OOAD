...
public abstract class Account {
    ...
    public Account(String accountId, String accountType, double accountBalance, 
                   String accountBranch, Customer owner) {  //  com.banking.controllers.models.Customer owner
        this.accountId = accountId;
        this.accountType = accountType;
        this.accountBalance = accountBalance;
        this.accountBranch = accountBranch;
        this.owner = owner;  //  stores com.banking.controllers.models.Customer object
    }
    ...
    public Customer getOwner() { return owner; }  //  Returns com.banking.controllers.models.Customer object
