public class Main {
    public static void main(String[] args) {
        ...
        SavingsAccount sa = new SavingsAccount("SA101", "Savings", "Main Branch", 1000.0, c1);
        InvestmentAccount ia = new InvestmentAccount("IA202", "Investment", "Main Branch", 2000.0, c1);
        ChequeAccount ca = new ChequeAccount("CA303", "Cheque", "Main Branch", "TechBots Ltd", c1);
        ...
        // Show results
        System.out.println("\n=== ACCOUNT SUMMARIES ===");
        System.out.println("Customer: " + c1.getCustomerName() + " " + c1.getCustomerSurname());
